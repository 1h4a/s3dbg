    ...
    <html lang="en">
      ...
      <div className="w-screen h-screen flex-col items-start justify-start p-24 tracking-tight">
        ...
        <span className="flex flex-row w-fit h-fit items-center justify-center gap-4 pointer-events-none pb-4">
          ...
          <Link href="/" className="h-full font-medium text-lg hover:underline hover:underline-offset-2 transition-all duration-500"> Config </Link>
            <Link href="/logging" className="h-full font-medium text-lg hover:underline hover:underline-offset-2 transition-all duration-500"> Logs </Link>
        </span>
          </div>
