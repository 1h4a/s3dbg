    ...
    fields: [
        {
            ...
            type: "string",
            id: "bucket",
            description: "Bucket and Key are mandatory values and most commands will fail without them."
        },
        {
            label: "Key",
            type: "string",
            ...
            fields: [
                {
                    ...
                    id: "source_bucket",
                    type: "string",
                    description: "Source values are used for copy operations. If not specified, s3dbg will try to apply the operation to and from the same bucket."
                },
                {
                    label: "Source Key",
                    optional: true,
        ...
        },
        {
            ...
            fields: [
                ...
                },
                {
                    ...
                    type: "string",
                    optional: true,
                    description: "Storage class for this object. (e.g. STANDARD, GLACIER, DEEP_ARCHIVE)"
                }
            ]
        },
        {
            ...
            fields: [
                {
                    ...
                    type: "string",
                    optional: true,
                    description: "ACL to set on the object. (e.g. private, public-read, etc.)"
                },
                {
                    label: "Grant Read",
                    id: "acl_grant_read",
            ...
            fields: [
                {
                    ...
                    type: "string",
                    id: "mod_range",
                    description: "Specifies byte range to retrieve. Expects format 'bytes=0-499'"
                },
                {
                    label: "ETag Match",
                    optional: true,
                    type: "string",
                    id: "mod_ifMatch",
                    description: "Returns the object only if its entity tag (ETag) is the same as the specified tag."
                },
                {
                    label: "No ETag Match",
                    optional: true,
                    type: "string",
                    id: "mod_ifNoneMatch",
                    description: "Returns the object only if its entity tag (ETag) is different from the specified tag."
                },
                {
                    ...
                    description: "Returns the object only if it has been modified since the specified date/time. Enter a date in string format, which will be parsed."
                },
                {
                    ...
                    description: "Returns the object only if it has not been modified since the specified date/time."
                },
                {
